...
输入冷知识随机抽一手佬们的冷知识
'''
List = ["g-c-z.cc的二级域名可以找axty搞个","老乌龟其实不是王八","test","axty也喜欢依神紫苑(所以拔刀⑧各位)(逃","广场镇官网底下有个↓劲↑爆↓歌↑单","axty曾经有许多花活设想(但整出来就是怪活了)","axty现在濒临破产，如有乐于捐助的可以私聊","我是大陸北方的一個網友，我對於你剛剛的話特別感興趣，請加我tg於我仔細探討","axty喜欢Fantasy_Z"]
